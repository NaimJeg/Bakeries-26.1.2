...
public class FlourSieveRecipeCategory extends AbstractRecipeCategory<RecipeHolder<FlourSieveRecipe>> {
    ...
    public FlourSieveRecipeCategory(IGuiHelper helper) {
        super(BakeriesRecipes.JEI.FLOUR_SIEVE, Component.translatable("container.bakeries.flour_sieve"), helper.createDrawableIngredient(VanillaTypes.ITEM_STACK,new ItemStack(BakeriesItems.FLOUR_SIEVE.get())), 109, 21);
    }

    @Override
    public void draw(RecipeHolder<FlourSieveRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
