...
public class DoughCraftingTableScreen extends AbstractContainerScreen<DoughCraftingTableMenu> {
    ...
    public DoughCraftingTableScreen(DoughCraftingTableMenu menu, Inventory inventory, Component title) {
    ...
    protected void extractTooltip(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        if (this.displayRecipes) {
            ...
            int endIndex = this.startIndex + 12;
            List<RecipeHolder<DoughCraftingTableRecipe>> visibleRecipes = this.menu.getVisibleRecipes();
            ...
            for (int index = this.startIndex; index < endIndex && index < visibleRecipes.size(); index++) {
                ...
                if (mouseX >= itemLeft && mouseX < itemLeft + 16 && mouseY >= itemRight && mouseY < itemRight + 18) {
                    ...
                    SlotDisplay buttonIcon = visibleRecipes.get(index).value().resultDisplay();
